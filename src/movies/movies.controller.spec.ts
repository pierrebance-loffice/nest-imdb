...
describe("MoviesController", () => {
  ...
  describe("findOne", () => {
    ...
    it("should return movie details", async () => {
      jest.spyOn(service, "findOne").mockResolvedValueOnce(mockMovieDetails);
  ...
  describe("discover", () => {
    ...
    it("should use default values if not provided", async () => {
      ...
      const result = await controller.discover({} as DiscoverMoviesDto);
